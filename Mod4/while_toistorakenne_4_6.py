...
# toteuttaa piin likiarvon laskennan edellä kuvatulla menetelmällä. Lopuksi ohjelma tulostaa piin likiarvon käyttäjälle.
...
while toistot < N:
    # arvotaan neliön sisälle koordinaatit
    x = uniform(-1, 1)
    y = uniform(-1, 1)
    # print(x, y)

    # jos osuu ympyrän sisälle kasvata n arvoa yhellä
    if x ** 2 + y ** 2 < 1:
        n += 1
    # kasvata toistojen määrää
    toistot += 1
